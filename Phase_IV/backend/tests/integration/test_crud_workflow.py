...
class TestCompleteCRUDWorkflow:
    ...
    def test_create_list_get_update_delete_workflow(self, client, auth_headers):
        ...
        assert (
            ...
            == "Organic milk, free-range eggs, whole grain bread"
        )
...
class TestStatusTransitions:
    ...
    @pytest.mark.integration
    def test_mark_task_complete_then_incomplete(
        self, client, auth_headers, sample_task_id
    ):
...
class TestStatusFiltering:
    ...
    def test_filter_incomplete_tasks(
        self, client, auth_headers, sample_task_id, sample_complete_task_id
    ):

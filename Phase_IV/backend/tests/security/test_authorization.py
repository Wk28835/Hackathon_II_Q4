...
class TestUserDataIsolation:
    ...
    def test_list_shows_only_user_tasks(
        self, client, auth_headers, sample_task, other_user_task
    ):
    ...
    @pytest.mark.security
    def test_get_other_user_task_returns_403(
        self, client, auth_headers, other_user_task_id
    ):
    ...
    @pytest.mark.security
    def test_mark_status_other_user_task_returns_403(
        self, client, auth_headers, other_user_task_id
    ):
